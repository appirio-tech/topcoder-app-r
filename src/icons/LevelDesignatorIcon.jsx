const LevelDesignatorIcon = ({ width, height, fill }) => {
  return (
    <svg width={ width || '20px' } height={ height|| '20px' } viewBox="0 0 20 20" version="1.1">
      <g id="Member-List" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
